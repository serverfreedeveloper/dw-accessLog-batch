...
public class Ftp {
  ...
  public boolean connect() throws Exception {
    ...
    log.info("Connected to Server: " + this.config.getHostName() + " on " + this.client.getRemotePort());
  ...
  public boolean put() throws Exception {
    ...
    if ( success ) {
      ...
      return putFiles(new File(this.config.getLocalPath()), this.config.getHostPath() + (this.config.getHostPath().endsWith("/") ? "" : "/"));
    }
    return success;
  }
